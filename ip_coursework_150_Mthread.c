...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
   cc -o ip_coursework_150_Mthread ip_coursework_150_Mthread.c -lglut -lGL -lm -pthread
...
void detect_edges(unsigned char *in, unsigned char *out, x_thread *args) {
  int i;
...
int main(int argc, char **argv) {
  ...
  x_thread T1_arguments;
  T1_arguments.start = 0;
  T1_arguments.stride = 4;

  x_thread T2_arguments;
  T2_arguments.start = 1;
  T2_arguments.stride = 4;

  x_thread T3_arguments;
  T3_arguments.start = 2;
  T3_arguments.stride = 4;

  x_thread T4_arguments;
  T4_arguments.start = 3;
  T4_arguments.stride = 4;

pthread_create(&T1, NULL, detect, &T1_arguments);
pthread_create(&T2, NULL, detect, &T2_arguments);
pthread_create(&T3, NULL, detect, &T3_arguments);
pthread_create(&T4, NULL, detect, &T4_arguments);
